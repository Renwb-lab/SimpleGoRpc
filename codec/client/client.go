...
import (
	"SimpleGoRpc/codec/balance/xclient"
...
func (client *Client) CallV0(serviceMethod string, args, reply interface{}) error {
...
func NewXClient(d xclient.Discovery, mode xclient.SelectMode, opt *service.Option) *XClient {
